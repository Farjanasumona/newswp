...
<div class="container">
        <form class="navbar-form "  method="post" name="form2">
            <input style="background-color: #cbe3c6" class="form-control" type="text" name="bid" placeholder="ID" required="">
            <input class="btn btn-default" type="submit" name="submit1" value="available">
            <input class="btn btn-default" type="submit" name="submit2" value="not-available">
          </form>
  ...
  <?php
    if(isset($_POST['submit']))
    {
          ...
          $s=mysqli_query($db,"SELECT * FROM libraryinfo where name like '%$_POST[search]%' ");
           ...
           <h3>List of libraries in which this book is available</h3> <?php
            ...
            echo "<table class='table table-bordered  table-hover' >";
              ...
              echo "<th>"; echo "Send Order Email"; echo "</th>";
      ...
      $res=mysqli_query($db,"SELECT  * FROM books ORDER BY name ;");
