...
<div id="main">
  ...
  <div class="container">
    <h2 style="font-family:Lucida Console;color:#333;">Remove Book from Library</h2><br>

  <form class="book" action="" method="post">
    <input class="form-control" type="text" name="name" placeholder="Book Name"> <br>
    <input  class="form-control" type="text" name="authors" placeholder="Author's Name"> <br>
    ...
    <input  class="form-control" type="text" name="department" placeholder="Department"> <br>
  ...
  <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        {mysqli_query($db,"DELETE FROM `books` WHERE name='$_POST[name]' and authors='$_POST[authors]' and edition='$_POST[edition]' and department='$_POST[department]';");
