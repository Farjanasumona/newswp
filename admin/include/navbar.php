      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li> <a href="admin_login.php"> <i class="fa fa-address-book"></i>Admin Login</a>  </li>
            <li> <a href="library/student/student_login.php"> <i class="fa fa-address-book"></i>Student Login</a>  </li>
            <li> <a href="library/student/student_registration.php"> <i class="fa fa-address-card"></i>Student Signup</a>  </li>
