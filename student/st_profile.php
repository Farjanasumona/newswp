	...
	.pic
	{
     ...
     <?php
   			if(isset($_POST['submit']))
   			{
                   ...
                   $sql ="UPDATE student SET image='$pic',firstname='$firstname',lastname='$lastname',username='$username',password='$password',contact='$contact' WHERE username='".$_SESSION['login_user']."';";
