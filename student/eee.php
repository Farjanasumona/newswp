...
<div id="main">
  ...
  <?php 
       if(isset($_POST['submit']))
    {
        ...
        $q=mysqli_query($db,"SELECT * FROM books where department='EEE' and name like '%$_POST[search]%' ");
      ...
      $res=mysqli_query($db,"SELECT * FROM books WHERE status='available' and department='EEE';");
