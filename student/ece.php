  ...
  <div class="dropdown">
    ...
    <span class="caret"></span></button>
      <ul class="dropdown-menu">
        <div class="h"><li ><a href="">ECE</a></li>
...
<div id="main">
  ...
  <?php 
       if(isset($_POST['submit']))
    {
        ...
        $q=mysqli_query($db,"SELECT * FROM books where department='ECE' and name like '%$_POST[search]%' ");
      ...
      $res=mysqli_query($db,"SELECT * FROM books WHERE status='available' and department='ECE';");
